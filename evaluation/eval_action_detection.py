...
class EvalActionDetection(object):
    ...
    def _import_ground_truth(self, ground_truth_filename):
        ...
        ground_truth = ground_truth.loc[
            ground_truth["t-start"].values < ground_truth["t-end"].values
    ...
    def evaluate(self, prediction):
        ...
        """
        logging.info(
            "\tNumber of predictions: {}. Number of unique videos: {}".format(
                len(prediction), len(np.unique(prediction["video-name"]))
            )
        )
