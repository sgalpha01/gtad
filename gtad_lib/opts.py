...
def parse_opt():
    ...
    # Overall settings
    parser.add_argument("--training_lr", type=float, default=0.00004)
    ...
    # dataset settings
    parser.add_argument("--video_info", type=str, default="./data/thumos_annotations/")
    parser.add_argument("--video_anno", type=str, default="./data/thumos_annotations/")
    parser.add_argument("--temporal_scale", type=int, default=256)  # 100 for anet
    parser.add_argument(
        "--feature_path",
        type=str,
    ...
    parser.add_argument(
        "--goi_samp", type=int, default=0
    )  # 0: sample all frame; 1: sample each output position
    parser.add_argument(
        "--goi_style", type=int, default=1
    )  # 0: no context, 1: last layer context, 2: all layer context

    # localization branch
    parser.add_argument("--kern_2d", type=int, default=3)
    parser.add_argument("--pad_2d", type=int, default=1)

    # NMS
    parser.add_argument("--nms_thr", type=float, default=0.46)
